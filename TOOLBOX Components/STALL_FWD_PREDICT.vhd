...
ENTITY STALL_FWD_PREDICT IS
	...
	PORT( 
			...
			-- Local (ID) Signals
			IMGEN : IN STD_LOGIC_VECTOR(2 DOWNTO  0); -- Used to detect U/R/S/J - Commands
...
ARCHITECTURE RTL OF STALL_FWD_PREDICT IS
	...
	SELECT_RS2 <= ITS_R           OR BRANCH OR (ITS_STORE AND (NOT LOAD_IN_EXE)); -- If the ID has a STORE and the EXE has OP != Load then again, 
